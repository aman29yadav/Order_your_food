...
import com.example.may.myproject.Model.Category;
import com.example.may.myproject.Model.Order;
import com.example.may.myproject.Model.Token;
import com.example.may.myproject.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
  ...
  //  Paper.init(this);
    ...
    private void updateToken(String token) {
       ...
       // Toast.makeText(Home.this,"phone="+Common.currentUser.getPhone(),Toast.LENGTH_SHORT).show();
        Log.i("msg","phone="+Common.currentUser.getPhone());
    ...
    private void loadMenu() {
        ...
        //final FirebaseRecyclerAdapter<Category,MenuViewHolder>
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            //delete remembered  user & password in Paper
            Paper.book().destroy();
